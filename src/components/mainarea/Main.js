...
const Main = () => {
    return (
        ...
        <div className="w-16 h-16 md:w-20 md:h-20 bg-transparent absolute bottom-5 left-1/2" >
            <a href="#about-me" className="absolute top-0 left-0 mt-12 block w-full h-full -translate-y-20 -translate-x-1/2 rotate-45 border-b-4  border-r-4 border-solid border-[#737373] animate-bumpy"></a>
        </div>
